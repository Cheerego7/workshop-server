...
import { NETLESS_ACCESS_KEY, NETLESS_SECRET_ACCESS_KEY } from "../config";
...
export const createWhiteboardRoomToken = (
    ...
    {
        readonly = false,
        lifespan = 1000 * 60 * 60 * 24 * 7,
    }: { readonly?: boolean; lifespan?: number } = {}
): string => {
    return roomToken(NETLESS_ACCESS_KEY, NETLESS_SECRET_ACCESS_KEY, lifespan, {
